...
# mapping between 10-20 (TUH, 19 channel) and 10-10 (LEMON, 62 channel) layouts
def standardize_sensors(raw_data, channel_config, return_montage=True):
	# 10-10 system - followed by LEMON
	# Brain Region	Left Hemisphere	Right Hemisphere
	# Frontal	F7-F3	F8-F4
	# Temporal	T7-C3	T8-C4
	# Parietal	P7-P3	P8-P4
	# Occipital	O1-P3	O2-P4

	# 10-20 system - followed by TUH
	# Brain Region	Left Hemisphere	Right Hemisphere
	# Frontal	F7-F3	F8-F4
	# Temporal	T3-C3	T4-C4
	# Parietal	T5-P3	T6-P4
	# Occipital	O1-P3	O2-P4
	...
	if return_montage == False:
		print("----- SENSOR SET REDUCED TO 14, NO MONTAGE -----")
	...
	print("----- SENSOR SET REDUCED TO 8, MONTAGE SET -----")
